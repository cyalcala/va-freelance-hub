...
describe("Shadow -> Canary Promotion Verification for GitLab and Grafana Labs", () => {
  test("validates and applies canary promotion through all constitutional triggers", async () => {
    ...
    const sourcesToTest = [
      {
        sourceId: "greenhouse:gitlab",
        providerId: "greenhouse",
        evidenceId: 6,
        sourceGovRev: 1,
        providerGovRev: 3,
        hash: "a261cbd422f5aca8aba212c8ec715de626e66c443007e8e84757bd04586b6cbb",
      ...
      },
      {
        ...
        sourceGovRev: 1,
        providerGovRev: 3,
        hash: "9872291badf191f0ae4414fff85fe6181c37cbfa00d43e05fd765c8271c593b0",
        endpoint: "https://boards-api.greenhouse.io/v1/boards/grafanalabs/jobs",
        policyExpiry: "2027-03-05T08:40:58.949Z",
        cap: 2,
      },
    ];
