#!/usr/bin/env bun
/**
 * Constitutional Shadow -> Canary Promotion for Proven Mature Workable Philippine VA Agencies:
 ...
 *   - workable:pineapple-staffing (cap: 1)
...
const SOURCES: SourceToPromote[] = [
  { sourceId: "workable:coconutva", cap: 2 },
  { sourceId: "workable:crewbloom", cap: 2 },
  { sourceId: "workable:hello-rache", cap: 2 },
  { sourceId: "workable:hunt-st", cap: 2 },
  { sourceId: "workable:pearltalent", cap: 2 },
  { sourceId: "workable:pineapple-staffing", cap: 1 },
  { sourceId: "workable:rocketams", cap: 2 },
];
...
async function main() {
  console.log("================================================================================");
  console.log("VA FREELANCE HUB — WORKABLE PH VA AGENCIES SHADOW -> CANARY PROMOTION");
  console.log("================================================================================");
