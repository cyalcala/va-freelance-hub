...
const budget: Budget = {
  ...
  githubRunsPerDay: budgetMode === "tight" ? 24 : Number(process.env.GH_RUNS_PER_DAY || 24), 
  cloudflareRunsPerDay: budgetMode === "tight" ? 48 : Number(process.env.CF_RUNS_PER_DAY || 72), 
