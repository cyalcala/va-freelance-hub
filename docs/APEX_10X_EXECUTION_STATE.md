...
| Identity Attribution | 100.0% coverage in production D1 (5,690 of 5,690 rows carry source_id) |
| Current 7d Qualified Baseline | 120 jobs / 7 days = 17.14 jobs/day (first-stored proxy, snapshot `2026-09-25T08-08-32-705Z.json`) |
