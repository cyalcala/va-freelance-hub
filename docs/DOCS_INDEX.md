...
1. AGENTS.md
2. docs/directory-organization-restoration-2026-08-21.md — **latest**: restores
   the category-first Agencies experience while retaining server pagination;
   records the verified-ownership data gap.
3. docs/karpathy-freshness-mobile-gauntlet-2026-08-21.md — 10-minute
   ...
   console-clean.
4. docs/ai-fallback-cascade-2026-08-20.md — free-first AI triage
...
5. docs/incident-2026-08-20-inngest-divert-freeze.md — board froze at Aug-18
