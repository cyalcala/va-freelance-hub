...
September 8 addendum: Teamtailor's primary article injects an otherwise
content-independent per-response CSP nonce. Reviewed exact-URL normalization
replaces only the unique 44-character Base64 nonce token wherever repeated;
