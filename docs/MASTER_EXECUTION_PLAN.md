...
| P1 | COMP-01 | durable robots evidence works after REL-12; reviewed enforcement remains blocked. COMP-01C pauses five Ashby identities; COMP-01D locally pauses the residual five Greenhouse/four Breezy `needs_review` identities pending integration authority | Ashby containment KEEP; residual ATS containment VERIFYING; no enforcement flip |
