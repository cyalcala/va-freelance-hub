...
| P1 | COMP-01 | 543/543 mature review; WWR canary and live empty-set rollback proven; exact six-source rollout separately verified and critic-approved | READY for exact-SHA deploy + 60-minute window |
